...
export const siteConfig = {
  // 1. 网站标题与博主信?
  title: "TGの个人博?,
  faviconUrl: "https://i.imgur.com/ymFkk3R.jpeg",
  authorName: "TG",
  bio: "在代码、学术之间穿梭的普通人?,

  navTitle: "TG",

  // 👇 【新增】导航栏中间的那个后缀/分隔符（默认?の）
  navSuffix: "?,

  navAfter: "个人博客",

  // 2. 头像设置 (支持网络链接，或将图片放?public 文件夹后使用 "/me.jpg")
  avatarUrl: "https://i.imgur.com/Hf3yp9B.jpeg",

  // 3. 网站背景设置 (二选一)
  // 如果想用纯图片背景，请在下面 bgImage 写路径，并将 useGradient 设为 false
  useGradient: false,
  themeColors: ["#a18cd1", "#fbc2eb", "#a1c4fd", "#c2e9fb"], // 呼吸流动的颜色组?
// 修改这里：变成图片数?
  ...
  // 4. 文章默认封面?(?Markdown 没写 cover 时显?
  defaultPostCover: "https://bu.dusays.com/2026/03/24/69c1e38b346cb.jpg",

  // 5. 首页照片墙预览图
  photoWallImage: "https://bu.dusays.com/2026/03/24/69c1e38b4c370.jpg",
  cloudMusicIds: ["1494711514", "2705769901", "3361006784", "2669019076", "2617285130", "1949073459", "2147142321", "2109171287", "33937479", "1854644975", "1480769848"],
  social: {
    github: "https://github.com/TG0412",
    gitee: "https://gitee.com/tg060412",
    google: "gugezhanghaozjh@gmail.com",
    email: "237761619@qq.com",
    qq: "237761619",
    wechat: "_Mrzeng0412",
  },
  counts: {
    photos: 128, // 照片墙数量可以手动写死或动态计?
  },
  chatterTitle: "云端杂谈", // 你可以改成任何你喜欢的名?
  chatterDescription: "代码、学术、提瓦特与泰拉大陆的碎片记录",


  // 👇 【新增】：全局背景弹幕配置
  danmakuList: ["在干嘛呢?, "有笨蛋嘛?, "前方高能反应?, "GROMACS 跑起来了吗？", "MD 模拟什么时候才能出图啊", "Graph Neural Networks 炼丹?..", "BUG 修复进度 99%", "今天背单词了吗？", "Tailwind CSS 拯救前端", "写算法中", "睡大觉中", "到底在干嘛？"],
  gitalkConfig: {
    clientID: "0v23litx7pfUHyJG298Z",
    clientSecret: "ee25684eadae86cb4fdf4b5dcd96c2b424395b4f",
    repo: "cangku",
    owner: "TG0412",
    admin: ["TG0412"],
  },
  ...
  friendLinkApplyFormat: "名称：TGの个人博客\n简介：今天我也要学习吗\n链接：https://mikudesu.beelzebul.top/\n头像：https://i.imgur.com/Hf3yp9B.jpeg",
